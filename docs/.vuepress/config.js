      ...
      sidebar: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '3.0 量化择时方法梳理', path:'/QuantStrategy&Technology/Chapter3/3.0量化择时方法梳理'},
            ...
            { title: '3.3 时变夏普率', path:'/QuantStrategy&Technology/Chapter3/3.3时变夏普率'},
            ...
            { title: '3.6 支持向量机', path:'/QuantStrategy&Technology/Chapter3/3.6支持向量机'},
          ]
        },
        {
